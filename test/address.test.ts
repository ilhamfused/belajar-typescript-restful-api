...
describe("PUT /api/contacts/:contactId/addresses/:addressId", () => {
  ...
  it("should be able to update address", async () => {
    ...
    const response = await supertest(app).put(`/api/contacts/${contact.id}/addresses/${address.id}`).set("X-API-TOKEN", "test").send({
      street: "Jalan sama kamu",
      city: "Semarang",
      province: "Jawa Tengah",
      country: "Indonesia",
...
describe("REMOVE /api/contacts/:contactId/addresses/:addressId", () => {
  beforeEach(async () => {
    await UserTest.create();
    await ContactTest.create();
    await AddressTest.create();
  ...
  it("should be able to remove address", async () => {
    ...
    const response = await supertest(app).delete(`/api/contacts/${contact.id}/addresses/${address.id}`).set("X-API-TOKEN", "test");
...
describe("GET /api/contacts/:contactId/addresses", () => {
  ...
  it("should be able to list addresses", async () => {
    ...
    const response = await supertest(app).get(`/api/contacts/${contact.id}/addresses`).set("X-API-TOKEN", "test");
